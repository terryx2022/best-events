...
/**
 * Creates an interface between HTTP server and database so that 
 * on server level we don't need to worry about what kind of underlying
 * database is being used (MySQL vs. MongoDB)
 * 
 * @author tianqix
 *
 */
